// miembros.js
// Con búsqueda y filtro, manteniendo la carga dinámica de miembros aprobados
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    try {
        usuariosAprobados = JSON.parse(localStorage.getItem('usuariosAprobados')) || [];
    } catch {
        usuariosAprobados = [];
    }
    if (!Array.isArray(usuariosAprobados)) usuariosAprobados = [];
