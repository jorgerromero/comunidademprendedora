...
function loadPendingUsers() {
    ...
    fetch('https://comunidademprendedora.es/data/pending-users.json')
...
function loadApprovedUsers() {
    // Simular carga de datos desde el servidor
    fetch('https://comunidademprendedora.es/data/approved-users.json')
        .then(response => response.json())
        .then(users => {
...
function approveUser(userId) {
    ...
    fetch('https://comunidademprendedora.es/api/approve-user', {
        method: 'POST',
        headers: {
...
function rejectUser(userId) {
    // Simular petición al servidor
    fetch('https://comunidademprendedora.es/api/reject-user', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
...
function deleteUser(userId) {
    // Simular petición al servidor
    fetch('https://comunidademprendedora.es/api/delete-user', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
